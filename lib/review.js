...
export function getPublicErrorMessage(error) {
  ...
  if (message.includes('ETIMEDOUT') || message.includes('GEMINI_REQUEST_TIMEOUT')) return '连接 Gemini 超时，请检查服务器是否能访问 Google，或配置 GEMINI_API_BASE_URL 为可访问的 Gemini 代理地址';
